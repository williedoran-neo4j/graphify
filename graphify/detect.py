...
def classify_file(path: Path) -> FileType | None:
    ...
    if not ext:
        # Extensionless build files (Makefile, Dockerfile) are CODE like their
        # suffixed cousins; everything else falls through to the shebang probe.
